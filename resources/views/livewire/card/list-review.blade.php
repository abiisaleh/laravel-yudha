<div>
    <article class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
        ...
        <div class="flex items-center mb-1 space-x-1 rtl:space-x-reverse mb-5">
            ...
            <footer class="ms-2 text-sm text-gray-500 dark:text-gray-400"><p>Reviewed on <time datetime="2017-03-03 19:00">March 3, 2017</time></p></footer>
        </div>
