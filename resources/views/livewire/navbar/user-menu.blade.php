<div>
    ...
    @else
        <a href="{{ route('dashboard') }}" class="bg-white hover:bg-primary-400 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-500 dark:hover:bg-primary-400 focus:outline-none ">Login</a>
    @endif
</div>
