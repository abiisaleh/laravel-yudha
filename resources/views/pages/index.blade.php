...
@section('content')
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-16 px-4 mx-auto max-w-screen-xl text-center lg:py-32 z-10 relative">
                ...
                <form class="w-full max-w-md mx-auto">   
                    ...
                    <div class="relative">
                        <input type="text" id="cari" class="block w-full p-4 text-sm text-gray-900 border border-gray-300 rounded-full bg-white focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-800 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter your keyword..." required>
                        <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-primary-500 hover:bg-primary-400 focus:outline-none  font-medium rounded-full text-sm px-4 py-2 dark:bg-primary-500 dark:hover:bg-primary-400">Cari</button>
                    </div>
                </form>

                <div class="mt-8 px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
        ...
        <section class="bg-primary-50 dark:bg-gray-800">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                <div class="mx-auto mb-8 lg:mb-12">
                    <h3 class="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-white">Service center terbaik! 🏆🤩</h3>
                    <ul class="flex">
                        <li><a href="#" class="text-gray-900 bg-primary-100 border border-primary-300 focus:outline-none hover:bg-primary-200 focus:ring-4 focus:ring-primary-200 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-primary-900 dark:text-white dark:border-primary-400 dark:hover:bg-primary-700 dark:hover:border-primary-600 dark:focus:ring-primary-700">Semua</a></li>
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="space-y-0.5 font-medium dark:text-white text-left rtl:text-right ms-3">
                                ...
                                <div class="text-sm text-gray-500 dark:text-gray-400 ">{{$item->user[0]['email']}}</div>
                            </div>
                        </div>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                <div class="mx-auto mb-8 lg:mb-12">
                    <h3 class="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-white">Paling banyak dikunjungi!</h3>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-200">Service center polpuler yang selalu rame.</p>
                    <ul class="flex">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                <div class="mx-auto mb-8 lg:mb-12">
                    <h3 class="mb-4 text-3xl tracking-tight font-bold text-gray-900 dark:text-white">Service center terdekat!</h3>
                    <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-200">Kunjungi service center yang ada didekatmu.</p>
                    <ul class="flex">
                        <li><a href="#" class="text-gray-900 bg-primary-100 border border-primary-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Semua</a></li>
                        <li><a href="#" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Abepura</a></li>
                        <li><a href="#" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Waena</a></li>
